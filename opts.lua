...
function opts.parse(arg)
  ...
  cmd:option('-snap', '/projects/grail/qihucnnb/ResNet_tmp_qi/', 'save the models here')
  cmd:option('-datapath', '/projects/grail/qihucn/CamVid', 'Path to the dataset')
  ...
  cmd:option('-model', 'model/ResNet.lua', 'Model File')
  cmd:option('-modelType', 2, 'type of the model (1 for M-Plain, 2 for M-RiR, and 3 for M-Hyper')
  cmd:option('-encModel', 'model/resnet-18.t7', 'encoder model trained on imagenet')
